...
Vector2 far_goal = Vector2(17.5, -126.5);
Vector2 near_goal = Vector2(122.7, -17.8);
Vector2 transposed_near_goal = Vector2(17.0, -127.0);
...
Vector2 skills_start = Vector2(40, -7.5); // middle encoder at abt 13.25 y
Vector2 skills_start_matchload = Vector2(64.5, -5.7); // middle encoder at abt 69.25, -7.7
Vector2 far_start = Vector2(130.5, -92); // middle encoder at abt 11.5
...
Vector2 skills_near_expansion = Vector2(16.5, -20);
